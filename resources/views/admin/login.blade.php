      ...
      <div class="navbar-container container center-layout">
        <div class="collapse navbar-collapse" id="navbar-mobile">
          <ul class="nav navbar-nav mr-auto float-left">
            <li class="nav-item d-none d-md-block hidden"><a class="nav-link nav-menu-main menu-toggle hidden-xs" data-toggle="modal" data-target="#exampleModal" href="#"><i class="ft-menu"></i></a></li>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <img src="https://i.imgur.com/JlHisc7.png" style="height: 100px; width: 100px;"  alt="branding logo">
                  </div>
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="index.html" novalidate="">
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="text" class="form-control input-lg" id="user-name" placeholder="Username" tabindex="1" required="" data-validation-required-message="Please enter your username.">
                      ...
                      <fieldset class="form-group position-relative has-icon-left">
                        <input type="password" class="form-control input-lg" id="password" placeholder="Password" tabindex="2" required="" data-validation-required-message="Please enter valid passwords.">
                        <div class="form-control-position">
                          <i class="la la-key"></i>
                        </div>
                        <div class="help-block font-small-3"></div>
                      ...
                      <button type="submit" class="btn btn-danger btn-block btn-lg"><i class="ft-unlock"></i>Connecter</button>
                    </form>
                  </div>
                </div>
