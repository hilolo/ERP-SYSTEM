    ...
    <div id="invoice-template" class="card-body">
        ...
        <div id="invoice-company-details" class="row">
            ...
            <div class="col-md-6 col-sm-12 text-center text-md-right">
                ...
                <p class="pb-3"># SO-0000{{ $files->id +1 }}</p>
              ...
              <select class="js-example-basic-single select2 form-control" onchange="getval(this);"   id="countries2" name="state2">
                  <option ></option>
                    ...
                    @endforeach
                          ...
                          <td class="text-left"><input style="width:60px;"  type="number"  class="form-control" id="Qte" value="1"  required="" name="Qte"></td>
        ...
        <div id="invoice-footer">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 text-center">
                    <button type="submit" class="btn btn-info btn-m my-1"><i class="la la-paper-plane-o"></i> 
            Sauvegarder
        </button>
          <button type="button" class="btn btn-success btn-m my-1"><i class="la la-check "></i> 
           confirmer
        </button>
