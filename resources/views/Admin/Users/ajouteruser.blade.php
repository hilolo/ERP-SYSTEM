...
<div class="row">
        <div class="col-md-12">
           ...
           <form class="form form-horizontal form-bordered" method="post"  action="/ajouteruser" enctype="multipart/form-data">
             {{ csrf_field() }}
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row mx-auto">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control border-primary" name="name" placeholder="email" id="userinput5">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mx-auto">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control border-primary" type="email"  name="email"  userinput6">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row mx-auto last">
                                            ...
                                            <div class="col-md-9">
                                                <input class="form-control border-primary" type="Password" name="password" id="userinput7">
                                            </div>
                                        </div>
                                 ...
                                 <div class="card-body">
                                              ...
                                              <fieldset class="checkbox">
                                                  <label>
                                                                    <input type="checkbox" name="Achat" value="1" checked="">
                                                    Achat
                                                                </label>
                                              </fieldset>
                                               ...
                                               <fieldset class="checkbox">
                                                  <label>
                                                                    <input type="checkbox" name="Comptable"   value="1" checked="">
                                                   Comptable
                                                                </label>
                                              </fieldset>
