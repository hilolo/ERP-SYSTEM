                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control" id="name" value="{{ $art->name }}" name="name" placeholder=" Nom" type="text">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="ifsc-code" name="code_b" placeholder="Code barre" type="text" value="{{ $art->code_barre }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="amount" value="{{ $art->prix }}"  name="prix" placeholder="Prix" type="number" required="">
                                    </div>
                                </div>
