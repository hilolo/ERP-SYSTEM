...
<div class="content-header row mb-1">
          <div class="content-header-left col-md-6 col-12 mb-2">
            <h3 class="content-header-title">Fournisseur</h3>
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="index.html">Ventes</a>
                  </li>
                  <li class="breadcrumb-item "><a href="#">Fournisseur</a>
                  </li>
                   <li class="breadcrumb-item active"><a href="#"> Modifier Fournisseur</a>
                  </li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title" id="bordered-layout-colored-controls">Modifier Fournisseur</h4>
                ...
                <div class="card-content collpase show">
                    <div class="card-body">
                        ...
                        <form class="form form-horizontal form-bordered" method="POST" action="/updateFournisseur/{{ $art->id }}" enctype="multipart/form-data">
