...
<div class="content-header row mb-1">
         ...
         <div class="float-right">
                        ...
                        <form action="/SupprimerFournisseur/{{ $art->id }}" method="POST">
                             {{ csrf_field() }}
                              <a class="btn btn-sm btn-info box-shadow-2 round btn-min-width pull-right white" href="/Achat/{{ $art->id }}/ModifierFournisseur" >
