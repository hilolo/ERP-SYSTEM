            ...
            <div class="row breadcrumbs-top">
              <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><a href="#">Les Demande de Prix</a>
                  </li>
					...
					<div class="table-responsive">
						<table class="table">
						  <tbody>
						  	...
						  	<tr>
						  		<td> Hors Taxes </td>
						  		<td class="text-right success">{{ $art -> Taxe  }} MAD</td>
						  	</tr>
						  	<tr>
		...
		<div id="invoice-footer">
			<div class="row">
				...
				<div class="col-md-5 col-sm-12 text-center">
					<form method="POST" action="/updateDemandePrix/{{ $art->id }}">
