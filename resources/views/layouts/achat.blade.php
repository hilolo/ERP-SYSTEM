      ...
      <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown"><span>Commandes</span></a>
          <ul class="dropdown-menu">
            ...
            <li class="dropdown " data-menu="dropdown-submenu"><a class="dropdown-item " href="#" data-toggle="dropdown">Demandes de prix </a>
            
            </li>
             <li class="dropdown " data-menu="dropdown-submenu"><a class="dropdown-item " href="#" data-toggle="dropdown">Bons de commande</a>
            
            </li>
              <li class="dropdown " data-menu="dropdown-submenu"><a class="dropdown-item " href="#" data-toggle="dropdown">Fournisseur</a>
        ...
        <li class="dropdown nav-item"  href="/Vente/Clients" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="/Vente/Clients" data-toggle="dropdown"></i><span>Fournisseur</span></a>
